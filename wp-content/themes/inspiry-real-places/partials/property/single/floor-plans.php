						...
						<div class="floor-plan-title clearfix">
							...
							<div class="floor-plan-meta">
								...
								if( ! empty( $floor['inspiry_floor_plan_bedrooms'] ) ) {
									...
									$bedrooms_label = ( $floor_bedrooms > 1 ) ? esc_html__( 'Bedrooms', 'inspiry' ) : esc_html__( 'Bedroom', 'inspiry' );
									echo '<div>';
								...
								if( ! empty( $floor['inspiry_floor_plan_bathrooms'] ) ) {
									...
									$bathrooms_label = ( $floor_bathrooms > 1 ) ? esc_html__( 'Bathrooms', 'inspiry' ): esc_html__( 'Bathroom', 'inspiry' );
									echo '<div>';
