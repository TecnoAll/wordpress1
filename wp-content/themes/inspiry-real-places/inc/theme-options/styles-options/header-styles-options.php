...
Redux::setSection( $opt_name, array(
		...
		'id'         => 'header-styles',
		'desc'       => esc_html__( 'This sub section contains header styles options.', 'inspiry' ),
		'subsection' => true,
		'fields'     => array(
			 ...
			 ***********************/
			  ...
			  */
			array(
				'id'       => 'inspiry_logo_on_print',
				'type'     => 'switch',
				'title'    => esc_html__( 'Hide Logo in Printing', 'inspiry' ),
				'desc'     => esc_html__( 'Do you want to hide the logo while printing?', 'inspiry' ),
				'default'  => 0,
				'on'       => esc_html__( 'Yes', 'inspiry' ),
				'off'      => esc_html__( 'No', 'inspiry' ),
			),
			array(
				'id'       => 'inspiry_logo_invert_on_print',
				'type'     => 'switch',
				'title'    => esc_html__( 'Invert Logo Colors in Printing?', 'inspiry' ),
				'desc'     => esc_html__( 'Are you using a white logo, this option will invert the colors of the logo in printing?', 'inspiry' ),
				'default'  => 0,
				'on'       => esc_html__( 'Yes', 'inspiry' ),
				'off'      => esc_html__( 'No', 'inspiry' ),
				'required' => array( 'inspiry_logo_on_print', '=', '0' ),
			),
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Menu Button Background Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#50b848',
					'hover'   => '#000000',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Menu Button Text Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#ffffff',
					'hover'   => '#ffffff',
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Background Color', 'inspiry' ),
				'desc'        => 'default: #50b848',
				'default'     => '#50b848',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '1' ),
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Text Color', 'inspiry' ),
				'desc'        => 'default: #20671b',
				'default'     => '#20671b',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Text Color on Hover', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Hover and Dropdown Background Color', 'inspiry' ),
				'desc'        => 'default: #46a13f',
				'default'     => '#46a13f',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '1' ),
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Dropdown Text Color', 'inspiry' ),
				'desc'        => 'default: #92df8c',
				'default'     => '#92df8c',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Dropdown Text Color on Hover', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Main Menu Dropdown Separator Color', 'inspiry' ),
				'desc'        => 'default: #48B040',
				'default'     => '#48B040',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Main Menu Close Button Background Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#33762e',
					'hover'   => '#000000',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Main Menu Close Button Icon Color', 'inspiry' ),
				'active'   => false,
			...
			array(
				...
				'title'       => esc_html__( 'Logo Background Color', 'inspiry' ),
				'desc'        => 'default: #000000',
				'default'     => '#000000',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '1' ),
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Logo Text Color', 'inspiry' ),
				'active'   => true,
			...
			array(
				...
				'type'        => 'color',
				'output'      => array( '.header-variation-one .site-logo' ),
				'title'       => esc_html__( 'Header Tagline Text Color', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Header Top Bar Background Color', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '1' ),
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'User Navigation Link Color', 'inspiry' ),
				'active'   => true,
			...
			array(
				...
				'title'       => esc_html__( 'Phone Background Color', 'inspiry' ),
				'desc'        => 'default: #0dbae8',
				'default'     => '#0dbae8',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '1' ),
			...
			array(
				...
				'title'       => esc_html__( 'Phone Text Color', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'type'        => 'color',
				'title'       => esc_html__( 'Phone Icon Color', 'inspiry' ),
				'desc'        => 'default: #0080BC',
				'default'     => '#0080BC',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Search Fields Background Color', 'inspiry' ),
				'desc'        => 'default: #dfe7ee',
				'default'     => '#dfe7ee',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Search Fields Background Color on Hover', 'inspiry' ),
				'desc'        => 'default: #f9f9fa',
				'default'     => '#f9f9fa',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Search Fields Dropdown Background Color on Hover', 'inspiry' ),
				'desc'        => 'default: #f9f9fa',
				'default'     => '#f9f9fa',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Search Fields Expand & Collapse Toggle Button Background Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#f4903f',
					'hover'   => '#0dbae8',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Search Fields Expand & Collapse Toggle Button Icon Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#C15302',
					'hover'   => '#ffffff',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Search Button Background Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#191c20',
					'hover'   => '#0dbae8',
			...
			array(
				...
				'title'       => esc_html__( 'Header Background Color', 'inspiry' ),
				'desc'        => 'default: #ffffff',
				'default'     => '#ffffff',
				'transparent' => false,
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Text Logo Color', 'inspiry' ),
				'active'   => true,
			...
			array(
				...
				'title'       => esc_html__( 'Tagline Color', 'inspiry' ),
				'desc'        => 'default: #4a525d',
				'default'     => '#4a525d',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'title'       => esc_html__( 'Border Color', 'inspiry' ),
				'desc'        => 'default: #e2e2e2',
				'default'     => '#e2e2e2',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '2' ),
			...
			array(
				...
				'title'       => esc_html__( 'Social Icons Color', 'inspiry' ),
				'desc'        => 'default: #b1b1b1',
				'default'     => '#b1b1b1',
				'validate'    => 'color',
				'transparent' => false,
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Submit Button Background Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#ff8000',
					'hover'   => '#0dbae8',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'Submit Button Text Color', 'inspiry' ),
				'active'   => false,
				'default'  => array(
					'regular' => '#ffffff',
					'hover'   => '#ffffff',
			...
			array(
				...
				'type'     => 'link_color',
				'title'    => esc_html__( 'User Navigation Colors', 'inspiry' ),
				'output'   => array( '.user-nav a' ),
				'default'  => array(
					'regular' => '#7c848b',
					'hover'   => '#4a525d',
			...
			array(
				...
				'title'       => esc_html__( 'Border Color', 'inspiry' ),
				'desc'        => 'default: #2e3135,' . ' ' . esc_html__( 'This border appears on smaller screen sizes.', 'inspiry' ),
				'default'     => '#2e3135',
				'transparent' => false,
				'required'    => array( 'inspiry_header_variation', '=', '3' ),
			),
