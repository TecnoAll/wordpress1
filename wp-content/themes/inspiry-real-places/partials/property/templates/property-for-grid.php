    ...
    <article class="property-listing-grid post-for-grid hentry clearfix">
        ...
        <div class="property-thumbnail">
            ...
            if( is_page_template( 'page-templates/favorites.php' ) ) {
                ...
                <div class="trash-favorite">
                    <a class="remove-from-favorite"
                       ...
                       title="<?php esc_html_e( 'Remove from favorites', 'inspiry' ); ?>">
            ...
            if ( $inspiry_options[ 'inspiry_property_card_gallery' ] ) {
                inspiry_property_gallery( $grid_property->get_post_ID(), intval( $inspiry_options[ 'inspiry_property_card_gallery_limit' ] ), 'post-thumbnail' );
            } else {
            ...
            <header class="entry-header">
                ...
                <div class="clearfix">
                    ...
                    if ( !empty( $grid_property_address ) ) {
                        ?><p class="property-address"><i class="fas fa-map-marker-alt"></i><?php echo esc_html( $grid_property_address ); ?></p><?php
                    }
                    ?>
            ...
            <div class="property-meta entry-meta clearfix">
                ...
                if ( $inspiry_property_beds ) {
                    ...
                    <div class="meta-item">
                        ...
                        <span><?php printf( esc_html__( '%d Beds', 'inspiry' ) , $inspiry_property_beds ); ?></span>
                    </div>
                    <?php
                }
                ...
                if ( $inspiry_property_baths ) {
                    ...
                    <div class="meta-item">
                        ...
                        <span><?php printf( esc_html__( '%d Baths', 'inspiry' ) , $inspiry_property_baths ); ?></span>
                    </div>
                    <?php
                }
