        ...
        if ( !empty( $slider_image ) ) {
            ...
            <li>
                <div class="slide-overlay hidden-xs hidden-sm container">
                    <div class="slide-inner-container">
                        ...
                        <div class="meta-item-half hidden-md">
                            <?php inspiry_property_meta( $slider_property, apply_filters( 'inspiry_slider_two_meta', array( 'meta' => array( 'area', 'beds', 'baths', 'garages', 'type' ) ) ) ); ?>
                        </div>
                ...
                <a href="<?php the_permalink(); ?>">
                    <img src="<?php echo esc_url( $slider_image ); ?>" alt="<?php the_title_attribute(); ?>" />
                </a>
