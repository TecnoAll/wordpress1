...
Redux::setSection( $opt_name, array(
    ...
    'desc'  => esc_html__('This section contains featured properties styles options.', 'inspiry' ),
    'subsection' => true,
    'fields'=> array (
        ...
        array(
            ...
            'title'     => esc_html__( 'Background Color for Odd Properties', 'inspiry' ),
            'desc'      => 'default: #f1f5f8',
            'default'   => '#f1f5f8',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Background Color for Even Properties', 'inspiry' ),
            'desc'      => 'default: #e9edf1',
            'default'   => '#e9edf1',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Overall Text Color on Hover', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Title Color on Hover', 'inspiry' ),
            'desc'      => 'default: #285d24',
            'default'   => '#285d24',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'type'      => 'color',
            'output'    => array( '.featured-properties-two .property-description' ),
            'title'     => esc_html__( 'Description Text Color', 'inspiry' ),
            'desc'      => 'default: #bfcad9',
            'default'   => '#bfcad9',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Title Bottom Border Color', 'inspiry' ),
            'desc'      => 'default: #5c646e',
            'default'   => '#5c646e',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Section Background Color', 'inspiry' ),
            'desc'      => 'default: #e9edf1',
            'default'   => '#e9edf1',
            'validate'  => 'color',
            'transparent' => false,
