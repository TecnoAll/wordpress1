...
Redux::setSection( $opt_name, array(
    'title' => esc_html__( 'Home Properties', 'inspiry'),
    'id'    => 'home-properties-styles',
    'desc'  => esc_html__('This section contains home properties styles options.', 'inspiry' ),
    'subsection' => true,
    'fields'=> array (
        ...
        array(
            ...
            'type'  => 'info',
            'style' => 'success',
            'title' => esc_html__('Home Properties Variation One', 'inspiry'),
            'desc'  => esc_html__('This variation consists of two different designs.', 'inspiry' ),
        ...
        array(
            ...
            'type' => 'section',
            'title' => esc_html__('Property Design One', 'inspiry'),
            'indent' => true,
            'required' => array( 'inspiry_home_properties_variation', '=', '1' ),
        ),
        ...
        array(
            ...
            'title'     => esc_html__( 'Title Color', 'inspiry' ),
            'default'   => array(
                'regular' => '#ffffff',
                'hover'   => '#0dbae8',
                'active'  => '#0dbae8',
        ...
        array(
            ...
            'title'     => esc_html__( 'Status Tag Text Color', 'inspiry' ),
            'active'    => false,
            'default'   => array(
                'regular' => '#4a525d',
                'hover'   => '#ffffff',
        ...
        array(
            ...
            'title'     => esc_html__( 'Status Tag Background Color', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Status Tag Background Color on Hover', 'inspiry' ),
            'desc'      => 'default: #ff8000',
            'default'   => '#ff8000',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Meta Text Color', 'inspiry' ),
            'desc'      => 'default: #c0c5cd',
            'default'   => '#c0c5cd',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Meta Value Text Color', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'type' => 'section',
            'title' => esc_html__('Property Design Two', 'inspiry'),
            'indent' => true,
            'required' => array( 'inspiry_home_properties_variation', '=', '1' ),
        ),
        ...
        array(
            'id' => 'inspiry_hp_2',
            'type' => 'section',
            'title' => esc_html__('Home Properties Variation Two', 'inspiry'),
            'indent' => true,
        ...
        array(
            ...
            'title'     => esc_html__( 'Background Color on Hover', 'inspiry' ),
        ...
        array(
            ...
            'title'     => esc_html__( 'Meta and Price Text Color on hover', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            'id' => 'inspiry_hp_3',
            'type' => 'section',
            'title' => esc_html__('Home Properties Variation Three', 'inspiry'),
            'indent' => true,
        ...
        array(
            ...
            'title'     => esc_html__( 'Welcome Board Title Color', 'inspiry' ),
            'desc'      => 'default: #191c20',
            'default'   => '#191c20',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Welcome Board Text Color', 'inspiry' ),
            'desc'      => 'default: #191c20',
            'default'   => '#191c20',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Description Background Color', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'mode'      => 'border-color',
            'output'    => array( '.property-listing-three-post .property-description' ),
            'title'     => esc_html__( 'Description Border Color', 'inspiry' ),
            'desc'      => 'default: #ebeef2',
            'default'   => '#ebeef2',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Description and Meta Text Color', 'inspiry' ),
            'desc'      => 'default: #929ba7',
            'default'   => '#929ba7',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Meta Wrapper Background Color', 'inspiry' ),
            'desc'      => 'default: #f7f8fa',
            'default'   => '#f7f8fa',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'mode'      => 'border-color',
            'output'    => array( '.property-listing-three-post .property-meta' ),
            'title'     => esc_html__( 'Meta Wrpper Top Border Color', 'inspiry' ),
            'desc'      => 'default: #ebeef2',
            'default'   => '#ebeef2',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Meta value Color', 'inspiry' ),
            'desc'      => 'default: #0dbae8',
            'default'   => '#0dbae8',
            'validate'  => 'color',
            'transparent' => false,
