                            ...
                            <article <?php post_class() ?>>
                                ...
                                <div class="post-content-wrapper">
                                    <div class="post-header entry-header">
                                        ...
                                        <div class="post-meta entry-meta">
                                            ...
                                            printf(
                                                ...
                                                sprintf(
                                                    '<a class="vcard author" rel="author" href="%1$s"><span class="fn">%2$s</span></a>',
                                    ...
                                    if ( !empty( $inspiry_options['inspiry_home_news_link_text'] ) ) {
                                        ?>
                                        <a class="read-more" href="<?php the_permalink(); ?>"><?php echo esc_html( $inspiry_options[ 'inspiry_home_news_link_text' ] ); ?> <i class="far fa-arrow-alt-circle-right"></i></a>
                                        <?php
                                    }
                                    ?>
