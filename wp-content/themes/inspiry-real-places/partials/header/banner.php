...
if ( is_page_template( 'page-templates/home.php' ) ) {      // Home page
    ...
    $inspiry_banner_title = sprintf( esc_html__( 'Search Results for: %s', 'inspiry' ), get_search_query() );
    ...
    $inspiry_banner_title = wp_strip_all_tags( get_the_archive_title() );
 ...
 */
if ( !$skip_banner ) {
    $inspiry_banner_bg_image_url = inspiry_get_banner_image();
    $inspiry_banner_bg_image = inspiry_filter_protocol( $inspiry_banner_bg_image_url );
    ...
    ?>
    <div class="page-head <?php echo esc_attr( $banner_variation_class ); ?>" style="<?php inspiry_generate_background( $inspiry_banner_bg_image ); ?>">
        <?php
