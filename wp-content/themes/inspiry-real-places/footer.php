    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 footer-logo fade-in-left <?php echo inspiry_animation_class(); ?>">
                 ...
                 * Footer Logo
                 */
                if ( isset( $inspiry_options['inspiry_footer_logo'] ) ) {
	                $inspiry_footer_logo     = $inspiry_options['inspiry_footer_logo']['url'];
	                $inspiry_footer_logo_url = inspiry_filter_protocol( $inspiry_footer_logo );
	                if ( ! empty( $inspiry_options['inspiry_footer_logo'] ) && ! empty( $inspiry_footer_logo ) ) {
		                ?>
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                            <img class="img-responsive" src="<?php echo esc_url( $inspiry_footer_logo_url ); ?>"
