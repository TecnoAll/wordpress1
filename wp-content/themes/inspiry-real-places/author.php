                    ...
                    <div class="col-xs-12 site-main-content">
                        ...
                        <main id="main" class="site-main">
                            ...
                            if ( $properties_list_query->have_posts() ) :
                                ...
                                ?><h3 class="agent-properties-list-heading"><?php esc_html_e( 'Properties by', 'inspiry' ); ?><span class="property-posted-by"> <?php echo esc_html( $current_author->display_name ); ?></span></h3><?php
