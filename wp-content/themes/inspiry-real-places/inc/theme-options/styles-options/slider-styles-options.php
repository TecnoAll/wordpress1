...
Redux::setSection( $opt_name, array(
    'title' => esc_html__( 'Slider', 'inspiry'),
    'id'    => 'slider-styles',
    'desc'  => esc_html__('This section contains properties slider styles options.', 'inspiry' ),
    'subsection' => true,
    'fields'=> array (
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Title Color', 'inspiry' ),
            'default'   => array(
                'regular' => '#ffffff',
                'hover'   => '#0dbae8',
                'active'  => '#0dbae8',
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Price Color', 'inspiry' ),
            'desc'      => 'default: #50b848',
            'default'   => '#50b848',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Status Text Color', 'inspiry' ),
            'active'    => false,
            'default'   => array(
                'regular' => '#4a525d',
                'hover'   => '#ffffff',
        ...
        array(
            ...
            'mode'      => 'background-color',
            'output'    => array( '.slide-overlay .property-status-tag'),
            'title'     => esc_html__( 'Property Status Background Color', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Status Background Color on Hover', 'inspiry' ),
            'desc'      => 'default: #ff8000',
            'default'   => '#ff8000',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Meta Text Color', 'inspiry' ),
            'desc'      => 'default: #ffffff',
            'default'   => '#ffffff',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Meta Value and Unit Text Color', 'inspiry' ),
            'desc'      => 'default: #939ca4',
            'default'   => '#939ca4',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'type'      => 'color',
            'title'     => esc_html__( 'Property Meta Icons Color', 'inspiry' ),
            'desc'      => 'default: #f4903f',
            'default'   => '#f4903f',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Overlay Top Border Color', 'inspiry' ),
            'desc'      => 'default: #d46206',
            'default'   => '#d46206',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Overlay Middle Border Color', 'inspiry' ),
            'desc'      => 'default: #404245',
            'default'   => '#404245',
            'transparent' => false,
            'required' => array( 'inspiry_slider_type', '=', 'properties-slider-two' ),
        ...
        array(
            ...
            'title'     => esc_html__( 'Button Color', 'inspiry' ),
            'default'   => array(
                'regular' => '#ffffff',
                'hover'   => '#ffffff',
                'active'  => '#ffffff',
        ...
        array(
            ...
            'title'     => esc_html__( 'Property Description Text Color', 'inspiry' ),
            'desc'      => 'default: #929ba7',
            'default'   => '#929ba7',
            'validate'  => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'title'     => esc_html__( 'Button Hover Background Color', 'inspiry' ),
            'desc'      => 'default: #0caeda',
            'default'   => '#0caeda',
            'transparent' => false,
            'required' => array( 'inspiry_slider_type', '=', 'properties-slider-three' ),
