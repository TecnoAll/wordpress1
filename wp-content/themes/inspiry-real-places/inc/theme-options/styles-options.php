...
Redux::setSection( $opt_name, array(
        ...
        'desc'  => esc_html__('This section contains styles related options.', 'inspiry'),
        'fields'=> array(),
    )
);
...
/*
 * Property Details Styles Options
 */
require_once ( get_template_directory() . '/inc/theme-options/styles-options/property-details-styles-options.php' );
