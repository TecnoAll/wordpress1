...
?>
<section class="submit-property submit-property-<?php echo esc_attr( $variation ); ?> fade-in-up <?php echo esc_attr( inspiry_animation_class() ); ?>" style="<?php inspiry_generate_background( $hiw_bg_img ); ?>">
            ...
            <div class="row submit-property-placeholders">
                ...
                <div class="<?php echo esc_attr( $hiw_column_class ); ?> submit-property-placeholder fade-in-up <?php echo esc_attr( inspiry_animation_class() ); ?>">
                    <div class="image-wrapper">
                        <img src="<?php echo esc_url( $inspiry_options['inspiry_hiw_1st_col_icon']['url'] ); ?>" alt="<?php echo esc_attr( $inspiry_options['inspiry_hiw_1st_col_title'] ); ?>"/>
                    </div>
                ...
                <div class="<?php echo esc_attr( $hiw_column_class ); ?> submit-property-placeholder fade-in-up <?php echo esc_attr( inspiry_animation_class() ); ?>">
                    <div class="image-wrapper">
                        <img src="<?php echo esc_url( $inspiry_options['inspiry_hiw_2nd_col_icon']['url'] ); ?>" alt="<?php echo esc_attr( $inspiry_options['inspiry_hiw_2nd_col_title'] ); ?>"/>
                    </div>
                ...
                <div
                    ...
                    <div class="image-wrapper">
                        <img src="<?php echo esc_url( $inspiry_options['inspiry_hiw_3rd_col_icon']['url'] ); ?>" alt="<?php echo esc_attr( $inspiry_options['inspiry_hiw_3rd_col_title'] ); ?>"/>
                    </div>
