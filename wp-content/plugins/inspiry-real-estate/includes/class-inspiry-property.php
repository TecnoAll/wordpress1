...
class Inspiry_Property {
    ...
    public function get_price() {
        ...
        if ( class_exists( 'WP_Currencies' ) && isset( $_COOKIE[ "current_currency" ] ) ) {
            ...
            if ( ire_currency_exists( $current_currency ) ) {    // validate current currency
                $base_currency = ire_get_base_currency();
                $converted_price = ire_convert_currency( $price_amount, $base_currency, $current_currency );
