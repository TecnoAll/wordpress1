...
class Inspiry_Real_Estate {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once IRE_PLUGIN_DIR . 'includes/class-inspiry-real-estate-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once IRE_PLUGIN_DIR . 'includes/class-inspiry-real-estate-i18n.php';

        /**
         * The class responsible for defining property functionality
         */
        require_once IRE_PLUGIN_DIR . 'includes/class-inspiry-property.php';

        /**
         * The class responsible for defining agent functionality
         */
        require_once IRE_PLUGIN_DIR . 'includes/class-inspiry-agent.php';

		/**
		 * The class responsible for providing properties listing VC element
		 */
		function ire_init_vc_elements() {
			require_once IRE_PLUGIN_DIR . 'vc-elements/properties.php';
		}
		add_action( 'vc_before_init', 'ire_init_vc_elements' );

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once IRE_PLUGIN_DIR . 'admin/class-inspiry-real-estate-admin.php';

        /**
         * The class responsible for providing property custom post type and related stuff.
         */
        require_once IRE_PLUGIN_DIR . 'admin/class-inspiry-property-post-type.php';

        /**
         * The class responsible for providing agent custom post type and related stuff.
         */
        require_once IRE_PLUGIN_DIR . 'admin/class-inspiry-agent-post-type.php';

        /**
         * The class responsible for providing partners custom post type and related stuff.
         */
        require_once IRE_PLUGIN_DIR . 'admin/class-inspiry-partner-post-type.php';

        /**
         * The class responsible for providing additional details meta box
         */
        require_once IRE_PLUGIN_DIR . 'admin/class-inspiry-additional-details-meta-box.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once IRE_PLUGIN_DIR . 'public/class-inspiry-real-estate-public.php';
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'admin_init', $plugin_admin, 'initialize_social_options' );
        $this->loader->add_action( 'admin_init', $plugin_admin, 'initialize_map_options' );
        $this->loader->add_action( 'admin_init', $plugin_admin, 'initialize_mc_options' );
        $this->loader->add_action( 'admin_init', $plugin_admin, 'initialize_recaptcha_options' );
        $this->loader->add_filter( 'plugin_action_links_' . INSPIRY_REAL_ESTATE_PLUGIN_BASENAME, $plugin_admin, 'ire_real_estate_action_links' );
        ...
        $this->loader->add_filter( 'rwmb_meta_boxes', $property_post_type, 'ire_property_type_meta_boxes' );
